...
product:
  ...
  exploration: "EXPL-cafe"                    # optional — EXPL-<id> of the phase-0 Exploration this Product was seeded from
...
When no exploration lineage is supplied, omit the optional exploration field entirely.
